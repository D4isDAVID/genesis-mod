...
public class DataComponentSetter<T> {
    ...
    public DataComponentSetter(DataComponentType<T> type, Function<Data, T> setter) {
        this(type, setter, false);
    }

    public DataComponentSetter(DataComponentType<T> type, Function<Data, T> setter, boolean reset) {
        this.type = type;
        this.setter = setter;
        this.reset = reset;
    }
    ...
    public void set(Data data) {
        T existingData = reset ? null : data.stack.get(type);
