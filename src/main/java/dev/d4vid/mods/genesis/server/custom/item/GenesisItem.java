...
public class GenesisItem {
    ...
    protected <T> void addSetter(DataComponentType<T> type, Function<DataComponentSetter.Data, T> setter) {
        addSetter(type, setter, false);
    }

    protected <T> void addSetter(DataComponentType<T> type, Function<DataComponentSetter.Data, T> setter, boolean reset) {
        dataComponentSetters.add(new DataComponentSetter<>(type, setter, reset));
    }
}
